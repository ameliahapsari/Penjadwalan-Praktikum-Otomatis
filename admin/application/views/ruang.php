...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><?php echo 'Ruangan';?></li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <!-- /.box-header -->
            <div class="box-body">
			<button type="button" class="btn btn-primary tambah_lelang" data-toggle="modal" data-target="#tambah_ruang" ><i class="fa fa-plus"></i> Tambah Ruangan</button> <br><br>
              ...
              <form id="simpan_ruang">
				...
				<div class="form-group">
                  ...
                  <select name="kategori" class="form-control" role="menu">
						...
						<li><option value="LABORATORIUM">LABORATORIUM</option></li>
				  </select>
                </div>
				<div class="form-group">
                  <label>Jurusan</label>
				...
				$('#delete').submit(function(){
							...
							$.ajax({
									 ...
									 async:false,
									  success: function(data){
									  if(data==true){
									  alert("Berhasil Menghapus Ruangan");
									  document.location.reload(true);
									  }
									  else{
