...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><?php echo 'Kelompok';?></li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <!-- /.box-header -->
            <div class="box-body">
			<button type="button" class="btn btn-primary tambah_lelang" data-toggle="modal" data-target="#tambah_kelas" ><i class="fa fa-plus"></i> Create Kelompok</button> <br><br>
          ...
          <div class="modal-dialog-tambah">
            <div class="modal-content-tambah">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Create Kelompok</h4>
              </div>
              ...
              <form id="simpan_kelas">
				...
				<div class="form-group">
                  ...
                  <input type="text" name="nama"  class="form-control" placeholder="Nama Kelompok">
                </div>
				...
				success: function(data){
					...
					for(i=0; i<data.length; i++){
						...
						'<div class="modal-header">'+
								  ...
								  '</button>'+
								'<h4 class="modal-title">Update Kelompok</h4>'+
							  '</div>'+
							  '<div class="modal-body">'+
								'<div class="box-body" >'+
								...
								'<div class="form-group">'+
								  '<label>Nama Kelompok</label>'+
								  '<input type="text" name="nama" value="'+data[i].nama_kelas+'"class="form-control" placeholder="Nama Kelompok">'+
								'</div>'+
							  ...
							  $('#simpan_edit')[0].reset();
								...
								$.ajax({
									 ...
									 async:false,
									  success: function(data){
									  if(data==true){
									  alert("Berhasil Mengedit Kelompok");
									  document.location.reload(true);
									  }
									  else{
									  alert('Gagal mengedit Kelompok');
									  }
							  ...
							  $('#simpan_kelas')[0].reset();
								...
								$.ajax({
									 ...
									 async:false,
									  success: function(data){
									  if(data==true){
									  alert("Berhasil Menambahkan Kelompok.");
									  $('#tambah_kelas').modal('hide');
										$('#simpan_kelas')[0].reset();
									  document.location.reload(true);
									  }
