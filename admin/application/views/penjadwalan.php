...
<div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
		...
		<a href="<?php echo base_url('penjadwalan3/excel_report');?>"> <button class="btn btn-primary pull-right"><i class="icon-plus"></i> Cetak Excel</button></a>
