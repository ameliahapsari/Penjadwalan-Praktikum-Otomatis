...
<head>
  ...
  <!-- Icon -->
  <link rel="shortcut icon" href="http://localhost/genetic/images/logo_lab.png">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url('index.php/dashboard/index');?>" class="logo">
      ...
      <span class="logo-mini"><b>SPPO Laboratorium Teknik Informatika</b>LT</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>SPPO Lab</b></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url();?>admin/dist/img/user.png" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $nama=$this->session->userdata("nama");?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo base_url();?>admin/dist/img/user.png" class="img-circle" alt="User Image">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
	  ...
	  if($aside=='asisten_bar'){
	  $asisten_bar='class = "active menu-open"';
	  }
	  else {
	  $asisten_bar=' ';
	  }
    ...
    if($aside=='mahasiswa_bar'){
    $mahasiswa_bar='class = "active menu-open"';
    }
    else {
    $mahasiswa_bar=' ';
    }

    if($aside=='jadwal_kuliah_bar'){
    $jadwal_kuliah_bar='class = "active menu-open"';
    }
    else {
    $jadwal_kuliah_bar=' ';
    }
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header"><h4><center><b>MENU PANEL</b></center></h4></li>
        <li  <?php echo $dashboard_bar; ?>>
          <a id="dashboard" onclick="myFunction(this.id)" href="<?php echo base_url('index.php/dashboard/index');?>">
		    ...
		    <li <?php echo $asisten_bar; ?>>
          <a id="asisten_bar" onclick="myFunction(this.id)" href="<?php echo base_url('index.php/asisten/index');?>">
            <i class="fa fa-user"></i> <span>Asisten</span>
          </a>
        </li>
        <li <?php echo $mahasiswa_bar; ?>>
          <a id="mahasiswa_bar" onclick="myFunction(this.id)" href="<?php echo base_url('index.php/mahasiswa/index');?>">
        ...
        <li <?php echo $matkul_bar; ?>>
          ...
          <a id="kelas_bar" onclick="myFunction(this.id)" href="<?php echo base_url('index.php/kelas/index');?>">
            <i class="fas fa-graduation-cap"></i> <span>Kelompok</span>
          </a>
        </li>
        ...
        <?php if ($this->session->userdata('level') == 'Kepala Laboran') { ?>
        <li <?php echo $jam_bar; ?>>
        ...
        <li <?php echo $pengampu_bar; ?>>
          <a href="<?php echo base_url('index.php/pengampu/index');?>">
            <i class="fas fa-users"></i> <span>Pengampuh Praktikum</span>
          </a>
        </li>
        
          <li <?php echo $penjadwalan_bar; ?>>
          <a href="<?php echo base_url('index.php/penjadwalan3/index');?>">
            <i class="fa fa-list"></i> <span>Penjadwalan Otomatis</span>
          </a>
        </li>
        <?php } ?>
        ...
        <li <?php echo $riwayat_bar; ?>>
          <a href="<?php echo base_url('index.php/riwayat_penjadwalan3/index');?>">
            <i class="fa fa-list"></i> <span>Jadwal Praktikum</span>
          </a>
        </li> 
    ...
    <?php if ($this->session->userdata('level') == 'Laboran') { ?>
