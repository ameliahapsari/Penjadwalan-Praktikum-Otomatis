      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <!-- /.box-header -->
            <div class="box-body">
			<button type="button" class="btn btn-primary tambah_lelang" data-toggle="modal" data-target="#tambah_mapel" ><i class="fa fa-plus"></i> Create Mata Kuliah</button> <br><br>
          ...
          <div class="modal-dialog-tambah">
            <div class="modal-content-tambah">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Create Mata Kuliah</h4>
              </div>
              ...
              <form id="simpan_mapel">
				...
				<div class="form-group">
                  ...
                  <select name="kategori" class="form-control" role="menu">
						<li><option value="TEORI">Teori</option></li>
						<li><option value="PRAKTIKUM">Praktikum</option></li>
				  </select>
                </div>
				<div class="form-group">
                  <label>Semester</label>
				  <select name="semester_tipe" class="form-control" role="menu">
						<li><option value="1">GANJIL</option></li>
						<li><option value="2">GENAP</option></li>
				  </select>
                </div>
				<div class="form-group">
                  <label>Jumlah SKS</label>
                  <input type="text" name="jumlah_jam" class="form-control" placeholder="Jumlah SKS">
                </div>
					...
					for(i=0; i<data.length; i++){
						...
						'<div class="modal-header">'+
							  ...
							  '<div class="modal-body">'+
								...
								'<div class="form-group">'+
								  '<label>Nama Mata Kuliah</label>'+
								  '<input type="text" name="nama"  value="'+data[i].nama+'" class="form-control" placeholder="Nama Mata Kuliah">'+
								'</div>'+
								'<div class="form-group">'+
								  '<label>Kode Mata Kuliah</label>'+
								...
								'<div class="form-group">'+
								  '<label>Jumlah SKS</label>'+
								  '<input type="text" name="jumlah_jam"  value="'+data[i].jumlah_jam+'" class="form-control" placeholder="Jumlah SKS">'+
								'</div>'+
							  ...
							  $('#simpan_mapel')[0].reset();
								...
								$.ajax({
									 ...
									 async:false,
									  success: function(data){
									  if(data==true){
									  alert("Berhasil Mengedit Mata Kuliah.");
									  $('#edit_mapel').modal('hide');
										$('#simpan_edit')[0].reset();
									  document.location.reload(true);
									  }
									  else{
									  alert('Gagal mengedit Mata Kuliah');
									  }
									  $('#edit_mapel').modal('hide');
									  $('#simpan_edit')[0].reset();
					...
					for(i=0; i<data.length; i++){
						...
						'<div class="modal-header">'+
								  '<button type="button" class="close" data-dismiss="modal" aria-label="Close">'+
									'<span aria-hidden="true">&times;</span>'+
								  '</button>'+
								'<h4 class="modal-title">Delete Mata Kuliah '+data[i].nama+' ?</h4>'+
							  '</div>'+
				...
				$('#delete').submit(function(){
							...
							$.ajax({
									 ...
									 async:false,
									  success: function(data){
									  if(data==true){
									  alert("Berhasil Menghapus MataKkuliah.");
									  document.location.reload(true);
									  }
									  else{
