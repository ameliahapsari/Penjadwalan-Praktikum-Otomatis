...
<head>
  ...
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Penjadwalan Praktikum Otomatis | Log in</title>
  <!-- Icon -->
  <link rel="shortcut icon" type="image/icon" href="http://localhost/genetic/images/logo_lab.png">
...
<body class="hold-transition login-page">
  <br><br>
   <center><img src="<?php echo base_url();?>admin/dist/img/logo_lab.png" width="200" height="200" /><br>
  <h2><b>Sistem Penjadwalan Praktikum Otomatis Laboratorium Teknik Informatika<br>Metode Algoritma Genetika</b></h2></center>
<div class="login-box">
  <!-- /.login-logo -->
