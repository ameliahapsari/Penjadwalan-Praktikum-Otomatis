...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><?php echo 'Populasi Awal';?></li>
      </ol>
    </section>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody id="semua_semester">
				 ...
				 echo'<td>';
							...
							echo $s->id_mapel.''.$s->id_semester.''.$s->id_asisten.''.$s->id_kelas.''.$s->id_prodi.''.$s->id_ruang.''.$s->id_jam.''.$s->id_hari.'-';	
							}
				echo'</td></tr>';	
				$k++;
				 }
					...
					for(i=0; i<data.length; i++){
						...
						'<div class="modal-header">'+
								  '<button type="button" class="close" data-dismiss="modal" aria-label="Close">'+
									'<span aria-hidden="true">&times;</span>'+
								  '</button>'+
								'<h4 class="modal-title">Hapus Semester '+data[i].nama_semester+' ?</h4>'+
							  '</div>'+
