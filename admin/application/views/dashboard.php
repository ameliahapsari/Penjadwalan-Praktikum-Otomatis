        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
                ...
                <br>
                <center><img src="<?php echo base_url();?>admin/dist/img/logo_lab.png" width="225" height="225" /></center>
                <center><h2><b>Selamat Datang di Sistem Penjadwalan Praktikum Otomatis</b></h2></center>
                <center><h3><b>Laboratorium Teknik Informatika</b></h2></center>
                  <br>
                <center><h4>Fakultas Teknik</h4></center>
                <center><h4>Universitas Muhammadiyah Jakarta</h4></center>
            </div>
            </div>
            <!-- /.box-body -->
          </div>
