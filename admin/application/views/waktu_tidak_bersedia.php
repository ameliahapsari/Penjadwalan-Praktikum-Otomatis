...
<div class="content-wrapper">
        ...
        <div class="col-xs-12">
          <div class="box">
			...
			<?php if(isset($msg)) { ?>                        
			  ...
			  <?php } ?>  
            <select id ="kode_asisten" name="kode_asisten" class="form-control" onchange="change_asisten_tidak_bersedia()">
               <?php if($ses_id_asisten!=NULL){ ?>
                  <option value="<?php echo $ses_id_asisten;?>" selected> <?php echo $ses_nama;?></option>
               <?php } else {
                  foreach($rs_asisten as $asisten) { 
               ?>
                     <option value="<?php echo $asisten->kode;?>" <?php echo isset($kode_asisten) ? ($kode_asisten === $asisten->kode ? 'selected':'') : '' ;?> /> <?php echo $asisten->nama;?>
               <?php 
                  } 
               } ?>
            </select>
              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				?>
                     <tr>
                        ...
                        <td>
                           <input type="checkbox" name="arr_tidak_bersedia[]" value="<?php echo $kode_asisten . '-'. $hari->kode . '-' . $jam->kode ?>" <?php echo $status; ?>> Tidak Bersedia
                        </td>
                     </tr>
                     <?php     
                        }                        
  ...
  <script type="text/javascript">
		...
		function change_asisten_tidak_bersedia() {
			var kode_asisten = document.getElementById('kode_asisten');			
			window.location.href = "<?php echo base_url().'index.php/waktu_tidak_bersedia/index/' ?>" + kode_asisten.options[kode_asisten.selectedIndex].value;		
		 }	   
            </script>
