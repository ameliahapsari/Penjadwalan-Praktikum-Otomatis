...
class Genetik2 extends CI_Controller
{
    ...
    //function __construct($jenis_semester=null, $tahun_akademik=null, $populasi=null, $crossOver=null, $mutasi=null, $kode_jumat=null, $range_jumat=null, $kode_dhuhur=null)
    {        
        parent::__construct();        
        ...
        $this->range_jumat    = explode('-',$range_jumat);//$hari_jam = explode(':', $this->waktu_asisten[$j][1]);
    ...
    public function AmbilData()
    {
           ...
           $rs_data = $this->db->query("SELECT   a.kode,"
                                    ...
                                    . "      AND c.tahun = '$this->tahun_akademik'");
