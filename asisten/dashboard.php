    ...
    <div class="sidebar">
      ...
      <br><br>
        <div class="info">
          <center>
          <?php  
          $sql=mysqli_query($koneksi, "SELECT foto FROM asisten WHERE kode='$_SESSION[kode]'") or die(mysqli_error($koneksi));
          $r=mysqli_fetch_array($sql);
          if($r["foto"]=="")
          {
            ?>
                <img src="dist/img/users.png" width="100px" height="100px" alt="User Image">
            <?php 
          }else{
             ?>
                 <img src="foto/<?php echo $r['foto'] ?>" class="" alt="User Image" width="75px" height="100px">
            <?php 
          }
          ?>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="?module=jadwal_asisten" class="nav-link">
              <i class="nav-icon fas fa-file"></i>
              <p>Jadwal Asisten</p>
            </a>
          </li>
