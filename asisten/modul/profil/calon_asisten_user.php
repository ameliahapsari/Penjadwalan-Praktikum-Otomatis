      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="card">
			...
			<tbody>
				<?php
				$sql =  mysqli_query($koneksi, "SELECT * FROM calon_asisten, user WHERE calon_asisten.username=user.username AND calon_asisten.username='$_SESSION[username]'") or die(mysqli_error($koneksi));
					$no = 1;
				...
				?>
						...
						<tr>
							...
							<td width="150" align="center">
								<a href="?module=detail_calon_asisten&id=<?php echo $row['id_calon_asisten']; ?>" title="Detail" class="btn btn-primary btn-sm"><i class="nav-icon fas fa-search"></i></a>
