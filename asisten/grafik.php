...
<?php
    $tahun=date("Y");
    $sql1 = "SELECT * FROM hasil, alternatif WHERE hasil.id_alternatif=alternatif.id_alternatif";
...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            ...
            $sql3 = "SELECT hasil FROM hasil WHERE id_hasil='$b2[id_hasil]'";
            $data3 = mysqli_query($koneksi, $sql3);
            while($a = mysqli_fetch_array($data3)) { echo $a['hasil'] . ', '; }} ?>], //Data Grafik
            backgroundColor: [
